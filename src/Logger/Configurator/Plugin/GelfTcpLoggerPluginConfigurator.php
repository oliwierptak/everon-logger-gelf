...
class GelfTcpLoggerPluginConfigurator extends \Everon\Logger\Plugin\Gelf\AbstractGelfSslPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    protected const METADATA = [
        'host' => ['type' => 'string', 'default' => \Gelf\Transport\TcpTransport::DEFAULT_HOST],
        'ignoreTransportErrors' => ['type' => 'bool', 'default' => true],
        'logLevel' => ['type' => 'string', 'default' => 'debug'],
        'pluginClass' => ['type' => 'string', 'default' => \Everon\Logger\Plugin\GelfTcp\GelfTcpLoggerPlugin::class],
        'pluginFactoryClass' => ['type' => 'string', 'default' => null],
        'port' => ['type' => 'int', 'default' => \Gelf\Transport\TcpTransport::DEFAULT_PORT],
    ...
    protected ?string $host = \Gelf\Transport\TcpTransport::DEFAULT_HOST;
    ...
    protected ?string $pluginClass = \Everon\Logger\Plugin\GelfTcp\GelfTcpLoggerPlugin::class;
    ...
    protected ?int $port = \Gelf\Transport\TcpTransport::DEFAULT_PORT;
