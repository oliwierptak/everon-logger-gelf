...
class GelfUdpLoggerPluginConfigurator extends \Everon\LoggerGelf\Configurator\AbstractGelfPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    protected const METADATA = [
        'pluginClass' => [
            'type' => 'string',
            'default' => \Everon\LoggerGelf\Plugin\GelfUdp\GelfUdpLoggerPlugin::class,
            'mappingPolicy' => [],
        ...
        'port' => ['type' => 'int', 'default' => 12201, 'mappingPolicy' => [], 'mappingPolicyValue' => 'port'],
        'chunkSize' => [
            'type' => 'int',
            'default' => \Gelf\Transport\UdpTransport::CHUNK_SIZE_WAN,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'chunkSize',
        ],
    ];

    protected array $updateMap = [];
    protected ?string $pluginClass = \Everon\LoggerGelf\Plugin\GelfUdp\GelfUdpLoggerPlugin::class;
    ...
    public function requireChunkSize(): int
    {
        ...
        $this->setupDateTimeProperty('chunkSize');
