...
class GelfTcpLoggerPluginConfigurator extends \Everon\LoggerGelf\Configurator\AbstractGelfSslPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    protected const METADATA = [
        'pluginClass' => [
            'type' => 'string',
            'default' => \Everon\LoggerGelf\Plugin\GelfTcp\GelfTcpLoggerPlugin::class,
            'mappingPolicy' => [],
        ...
        'autoSslPort' => [
            ...
            'default' => 12202,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'autoSslPort',
        ],
        'sslOptions' => [
            'type' => 'popo',
    ...
    protected ?string $pluginClass = \Everon\LoggerGelf\Plugin\GelfTcp\GelfTcpLoggerPlugin::class;
    ...
    protected ?int $autoSslPort = 12202;
